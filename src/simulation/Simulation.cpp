...
auto simulation::setup_simulation(
  ...
  kernel::initializeFieldConditions(
      cols_, rows_, pml_cells_x_, pml_cells_y_,
      permittivity_function, conductivity_function, chi1_function,
  ...
  kernel::initializeCPML1DProfile(
      cols_, pml_cells_x_, grid_.BeX(), grid_.AeX(), grid_.InvKeX(),
      grid_.BhX(), grid_.AhX(), grid_.InvKhX(), dt_, dx_);

  kernel::initializeCPML1DProfile(
      rows_, pml_cells_y_, grid_.BeY(), grid_.AeY(), grid_.InvKeY(),
      grid_.BhY(), grid_.AhY(), grid_.InvKhY(), dt_, dx_);
}
...
auto simulation::step_simulation() -> void {
  ...
  kernel::calculateFutureDEISFields(
      ...
      grid_.Sfield(), grid_.Hxfield(), grid_.Hyfield(),
      grid_.PsiEzx(), grid_.PsiEzy(),
      grid_.BeX(), grid_.AeX(), grid_.InvKeX(),
      grid_.BeY(), grid_.AeY(), grid_.InvKeY(),
      grid_.ECoeff(), grid_.ICoeff(), grid_.SMCoeff(), grid_.SDCoeff(),
      dt_, dx_);

  kernel::calculateFutureHField(
      cols_, rows_, grid_.Hxfield(), grid_.Hyfield(), grid_.Ezfield(),
      grid_.PsiHxy(), grid_.PsiHyx(),
      grid_.BhX(), grid_.AhX(), grid_.InvKhX(),
      grid_.BhY(), grid_.AhY(), grid_.InvKhY(),
      dt_, dx_);
